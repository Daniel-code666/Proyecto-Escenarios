...
<body>
    <div class="container">
        <?php
        foreach ($this->dataStore("subStageSimple") as $data) {
            echo ("<title>" . (string) $data['name_understg'] . "</title>");
            echo ("<h1 style='text-align:center'>Informe del sub escenario " . (string) $data['name_understg'] . "</h1>");
        }
        ?>
    </div>
    ...
    <div class="warpper">
        <div class="panels">
            ...
            <div class="row_fixed">
                <h3>Informe de estado del sub escenario</h3>
            </div>
            <div class="row_fixed">
                <?php
                foreach ($this->dataStore("subStageSimple") as $stageInfo) {
                    ...
                    (string) $stageInfo['message_state_understg'] . "</b></h4></div>");
                }
                ?>
            </div>
            <div class="row_fixed">
                <h3>Recursos en los almacenes del sub escenario</h3>
            </div>
            <div class="row_fixed">
            ...
            <div class="row_fixed">
                <div class="col-12 center">
                    ...
                    if ($this->dataStore("subResources")->count() == 0) {
                        ...
                        $tempArray = array();
                        $tempObj = $this->dataStore("subResources");
            ...
            <div class="row_fixed">
                <h3>Recursos en uso del sub escenario</h3>
            </div>
            <div class="row_fixed">
                <div class="col-4 card_center">
                    <div class="card" style="width: 18rem;">
            ...
            <div class="row_fixed">
                <div class="col-12 center">
                    ...
                    if ($this->dataStore("subResourcesInUse")->count() == 0) {
                        ...
                        $tempArray = array();
                        $tempObj = $this->dataStore("subResourcesInUse");
                        foreach ($tempObj as $obj) {
                            array_pop($obj);
                            array_pop($obj);
                            array_push($tempArray, $obj);
            ...
            <div class="row_fixed">
                <div class="col-12">
                    <h3>Cantidad de recursos por estado en el sub escenario</h3>
                    <div class="center">
                        <?php
                        $subResourcesByStates = array();

                        foreach ($this->dataStore('subResourcesStates') as $info1) {
                            foreach ($this->dataStore('subResourcesStates2') as $info2) {
                                if ($info1['statesName'] == $info2['statesName']) {
                                    ...
                                    array_push($subResourcesByStates, $rByStates);
                                }
                            }
                        }
            ...
            <div class="row_fixed">
                <h3>Cantidad de recursos por almacén en el sub escenario</h3>
            </div>
            <div class="row_fixed">
                <div class="col-12">
                    <?php
