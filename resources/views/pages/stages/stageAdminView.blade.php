        ...
        <div class="card-body px-lg-3 py-lg-3">
            <div class="row">
                <div class="col-md-7">
                    ...
                    <img class="offset-0" src="{{isset($stage->photo)?asset('storage').'/'.$stage->photo:''}}" alt="{{$stage->name}}" width="550">
                </div>
                <div class="col-md-4">
                    <div class="row">
            ...
            <div class="warpper">
                ...
                <div class="tabs">
                    ...
                    <label class="tab" id="three-tab" for="three">Sub escenarios</label>
                ...
                <div class="panels">
                    ...
                    <!-- panel de la ubicación del escenario -->
                    <div class="panel" id="four-panel">
                        <div class="panel-title">Ubicación del escenario</div>
