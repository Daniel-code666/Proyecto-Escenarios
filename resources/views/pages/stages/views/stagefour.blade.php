        ...
        <div class="row">
            <div class="col-xl-12 order-xl-1">
                ...
                <div class="card-body" >
                    ...
                    <p>
                        También vale destacar otros servicios como los baños para deportistas y las seis baterías para el público, los vestieres, los saunas, el baño turco, la sala de prensa y la sala de jueces que se complementan con gimnasio, cafetería y tres locales comerciales que se alquilan a particulares.
                    </p>
                    
                    <hr>
                    <h3 class="h3" style="font-size: 25px">En el Complejo Acuático Simón Bolívar se cuenta con los siguientes servicios:</h3>
                    <ul>
                        <li>Escuela de natación IDRD fines de semana (5 a 12 años) </li>
                        <li>Entrenamiento Ligas Deportivas (Sub acuáticas, triatlón, Natación)</li>
                        <li>Programa institucional J.E.C</li>
                        <li>Entrenamiento natación rendimiento en las diferentes disciplinas</li>
                        <li>Natación clásica</li>
                        <li>Natación paralímpica</li>
                        <li>Clavados</li>
                        <li>Polo acuático</li>
                        <li>Escenario para los grandes eventos de las diferentes disciplinas de natación.</li>
                    </ul>
                    <h3 class="h3" style="font-size: 25px">Contactenos:</h3>
                    <ul>
                        <li><b>TELÉFONO:</b> 2 210 622 Ext 110 y 112.</li>
                        <li><b>Correo:</b> complejoacuatico@idrd.gov.co</li>
                    </ul>
                    <hr>
