...
<h2 class="text-center fw-bold mt-2">Parametrización estado de los escenarios</h2>
...
<div class="warpper">
  <div class="panels">
    <div class="row">
      <div class="col-md-8">
        <p>
          Las parametrizaciones de escenarios sirven como regla o escala que mide las condiciones físicas de
          los lugares, de esta manera se puede caracterizar el escenario a través de una medida que indicará
          la situación estructural del mismo.
        </p>
        <a type="button" class="btn btn-primary" href="{{ url('/states/create') }}">Crear estado</a>
      </div>
      <div class="col-sm-4">
        <img class="img-center" src="{{ asset('argon') }}/img/brand/rule.png" width="180" alt="...">
      </div>
    </div>
    <hr>
    @if($misclist->isEmpty())
