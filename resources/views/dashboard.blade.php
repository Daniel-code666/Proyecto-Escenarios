        ...
        <div class="col-sm-5">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-text">
                        Desde aquí podrá ver toda la información a través de gráficos y tablas de los 
                        escenarios, almacenes e inventarios. Adicionalmente podrá revisar toda la 
                        información relacionada de los subescenarios.
                    </p>
                    <a href="{{url('stagereport')}}" class="btn btn-primary">Click aquí</a>
                </div>
            </div>
        </div>
    </div>
